  ...
  return (
    <View style={styles.container}>
      <View style={styles.header}>
        <Text style={styles.welcomeText}>Welcome, {user?.name || 'Demo User'}!</Text>
        <Text style={styles.subtitle}>Your campus at your fingertips</Text>
      </View>
      ...
      <View style={styles.section}>
        ...
        <View style={styles.quickActions}>
          ...
          >
            <Text style={styles.actionTitle}>Book a Facility</Text>
          </TouchableOpacity>
          <TouchableOpacity 
            style={styles.actionCard}
            onPress={() => navigation.navigate('Classrooms')}
          >
            <Text style={styles.actionTitle}>Find a Classroom</Text>
          </TouchableOpacity>
          <TouchableOpacity 
            style={styles.actionCard}
