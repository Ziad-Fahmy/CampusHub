...
const EventRegistration = require("../models/EventRegistration"); // Import EventRegistration model

// @route   POST api/events
// @desc    Create a new event
// @access  Private (assuming only authenticated users can add events)
router.post(
  "/",
  [
...
// @access  Private (assuming only authenticated users can delete events)
router.delete("/:id", auth, async (req, res) => {
  try {
    ...
    // Check user (optional: if you want only the creator to delete)
...
// @access  Public (or Private if only logged-in users can register)
router.post(
  "/register",
  [
